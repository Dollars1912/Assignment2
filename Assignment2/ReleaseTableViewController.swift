...
class ReleaseTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    func insetInitialDataToDatabase() {
        ...
        sneaker.id = 1
        sneaker.release_date = (formatter.date(from: "2018/11/24") as NSDate?)!
        sneaker.price = 220.0
        ...
        sneaker.id = 2
        sneaker.release_date = (formatter.date(from: "2018/11/08") as NSDate?)!
        sneaker.price = 120.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 3
        sneaker.release_date = (formatter.date(from: "2018/10/20") as NSDate?)!
        sneaker.price = 500.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 4
        sneaker.release_date = (formatter.date(from: "2018/09/08") as NSDate?)!
        sneaker.price = 139.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 5
        sneaker.release_date = (formatter.date(from: "2018/08/04") as NSDate?)!
        sneaker.price = 180.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 6
        sneaker.release_date = (formatter.date(from: "2018/06/03 ") as NSDate?)!
        sneaker.price = 180.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 7
        sneaker.release_date = (formatter.date(from: "2018/05/13") as NSDate?)!
        sneaker.price = 200.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 8
        sneaker.release_date = (formatter.date(from: "2018/03/01") as NSDate?)!
        sneaker.price = 230.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 9
        sneaker.release_date = (formatter.date(from: "2018/02/13 ") as NSDate?)!
        sneaker.price = 200.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 10
        sneaker.release_date = (formatter.date(from: "2018/01/09") as NSDate?)!
        sneaker.price = 170.0
        sneaker.name = "PUMA Fenty Bow women's Sneaker : PNA"
