...
class ReleaseTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let data = NSEntityDescription.insertNewObject(forEntityName: "Sneaker", into: managedObjectContext) as? Sneaker
        data!.id = 1
        let formatter = DateFormatter()
        formatter.dateFormat = "yyyy/MM/dd HH:mm"
        data!.release_date = formatter.date(from: "2016/10/08 22:31") as NSDate?
        data!.price = 220.0
        data!.name = "nike"
        // save to db
