...
class ReleaseTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    func loadFromDatabase() {
        ...
        sneaker.id = 1
        sneaker.release_date = (formatter.date(from: "2017/04/24 22:31") as NSDate?)!
        sneaker.price = 220.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 3
        sneaker.release_date = (formatter.date(from: "2016/09/20 22:31") as NSDate?)!
        sneaker.price = 500.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 4
        sneaker.release_date = (formatter.date(from: "2017/04/08 22:31") as NSDate?)!
        sneaker.price = 139.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 5
        sneaker.release_date = (formatter.date(from: "2017/04/04 22:31") as NSDate?)!
        sneaker.price = 180.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 7
        sneaker.release_date = (formatter.date(from: "2017/04/13 22:31") as NSDate?)!
        sneaker.price = 200.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 8
        sneaker.release_date = (formatter.date(from: "2018/01/01 22:31") as NSDate?)!
        sneaker.price = 230.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 9
        sneaker.release_date = (formatter.date(from: "2017/05/13 22:31") as NSDate?)!
        sneaker.price = 200.0
        ...
        sneaker = Sneaker(context: managedObjectContext)
        sneaker.id = 10
        sneaker.release_date = (formatter.date(from: "2017/03/09 22:31") as NSDate?)!
        sneaker.price = 170.0
        sneaker.name = "PUMA Fenty Bow women's Sneaker : PNA"
